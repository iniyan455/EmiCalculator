...
public class Emi implements Serializable {
    ...
    public Emi(double opening_balance, double total_emiamount, double interest_permonth,
               double principal_paidamount, double closing_balance, double duration, Date createdDate) {
        this.opening_balance = opening_balance;
        this.total_emiamount = total_emiamount;
        this.interest_permonth = interest_permonth;
        this.principal_paidamount = principal_paidamount;
