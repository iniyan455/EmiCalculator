...
public class Monthly implements Serializable {
    ...
    public Monthly(double opening_balance, double total_emiamount, double interest_permonth, double principal_paidamount, double closing_balance, double duration, Date createdDate) {
